...
export const langConfig: { [key: string]: LangConfig | LangConfig[] } =
config.get('refactor-css.classRegex') || {};

export const sortOrder = config.get('refactor-css.defaultSortOrder');

export const customTailwindPrefixConfig = config.get('refactor-css.customTailwindPrefix');
export const customTailwindPrefix =
typeof customTailwindPrefixConfig === 'string'
	? customTailwindPrefixConfig
	: '';

export const shouldRemoveDuplicatesConfig = config.get('refactor-css.removeDuplicates');
export const shouldRemoveDuplicates =
typeof shouldRemoveDuplicatesConfig === 'boolean'
	? shouldRemoveDuplicatesConfig
	: true;

export const shouldPrependCustomClassesConfig = config.get(
'refactor-css.prependCustomClasses'
);
export const shouldPrependCustomClasses =
